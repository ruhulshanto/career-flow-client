...
import signInSvgImg from '../../../assets/Authenticaion/SignInSVG.svg';
...
const Login = () => {
  ...
  const onSubmit = (data) => {
   ...
   signInUser(data.email, data.password)
      .then(result => {
        ...
        console.log(user);
        Swal.fire({
          title: "Your Sign in Successfully!",
          icon: "success",
          draggable: true,
          timer: 1000,
  ...
  return (
    <div
      ...
      className="flex items-center justify-center bg-cover bg-center pt-8">
